...
class SevaLoader extends StatefulWidget {
  final List<Color> colors;
  final Duration duration;

  SevaLoader({this.colors, this.duration});

  @override
  _SevaLoaderState createState() =>
      _SevaLoaderState(this.colors, this.duration);
}

class _SevaLoaderState extends State<SevaLoader>
