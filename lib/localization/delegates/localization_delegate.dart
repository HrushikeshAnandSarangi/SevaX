...
class _SnMaterialLocalizationsDelegate
    extends LocalizationsDelegate<MaterialLocalizations> {
  const _SnMaterialLocalizationsDelegate();
  ...
  @override
  bool shouldReload(_SnMaterialLocalizationsDelegate old) => false;
}

class SnMaterialLocalizations extends GlobalMaterialLocalizations {
  const SnMaterialLocalizations({
  ...
  static const LocalizationsDelegate<MaterialLocalizations> delegate =
      _SnMaterialLocalizationsDelegate();
