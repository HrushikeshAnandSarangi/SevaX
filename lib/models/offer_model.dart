    ...
    if (type != null) {
      switch (type) {
        ...
        case RequestType.ONE_TO_MANY_OFFER:
          map['requestType'] = "ONE_TO_MANY_REQUEST";
          break;
        case RequestType.ONE_TO_MANY_OFFER:
