...
class RequestModel extends DataModel {
  ...
  RequestModel.fromMap(Map<String, dynamic> map) {
    ...
    if (map.containsKey('goodsDonationDetails')) {
      print("Key is present for Goods and dontaions...");
      this.goodsDonationDetails =
          GoodsDonationDetails.fromMap(map['goodsDonationDetails']);

      print(goodsDonationDetails.toString());
    } else {
      print("Key for donation is not present...");
    }
...
//      this.end = map['end'];
  ...
  Map<String, dynamic> toMap() {
    ...
    object['cashModeDetails'] = this.cashModel.toMap() ?? null;
...
class GoodsDonationDetails {
  ...
  GoodsDonationDetails.fromMap(Map<String, dynamic> map) {
    ...
    if (map.containsKey("requiredGoods")) {
      Map<String, Map<dynamic, dynamic>> temp =
          Map<String, Map<dynamic, dynamic>>.from(map["requiredGoods"]);
      var requiredGoods = HashMap();
      temp.forEach((key, value) {
        requiredGoods[key] = value;
      });
