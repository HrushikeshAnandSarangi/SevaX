...
class RequestModel extends DataModel {
  ...
  RequestModel.fromMap(Map<String, dynamic> map) {
    ...
    if (map.containsKey('donationType')) {
      if (map['donationType'] == "CASH") {
        this.donationType = DonationType.CASH;
      } else if (map['requestMode'] == "GOODS") {
        this.donationType = DonationType.GOODS;
      } else {
        this.donationType = DonationType.TIME;
      }
    } else {
      this.donationType = DonationType.TIME;
    }
    ...
    if (donationType != null) {
      switch (donationType) {
        case DonationType.CASH:
          object['donationType'] = "CASH";
          break;

        case DonationType.GOODS:
          object['donationType'] = "GOODS";
          break;

        case DonationType.TIME:
          object['donationType'] = "TIME";
          break;
      }
    } else {
      object['donationType'] = "TIME";
