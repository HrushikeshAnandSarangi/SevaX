...
class RequestModel extends DataModel {
  ...
  List<String> recommendedMembeIdsForRequest = [];
  ...
  RequestModel.fromMap(Map<dynamic, dynamic> map) {
    ...
    if (map.containsKey('recommendedMembeIdsForRequest')) {
      List<String> recommendedMembeIds =
          List.castFrom(map['recommendedMembeIdsForRequest']);
...
//      this.end = map['end'];
  ...
  Map<String, dynamic> toMap() {
    ...
    if (this.recommendedMembeIdsForRequest != null) {
      object['recommendedMembeIdsForRequest'] =
          this.recommendedMembeIdsForRequest;
    }
