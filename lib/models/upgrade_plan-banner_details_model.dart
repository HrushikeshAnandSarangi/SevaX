  ...
  factory UpgradePlanBannerModel.fromJson(Map<String, dynamic> json) =>
      UpgradePlanBannerModel(
          ...
          stock_images: json.containsKey("stock_images")
              ...
              : null,
          user_defined_skills_interests: json.containsKey("user_defined_skills_interests")
          ...
          cash_request: json.containsKey("cash_request")
              ...
              : null,
          goods_request: json.containsKey("goods_request") ? BannerDetails.fromJson(json["goods_request"]) : null);
}
