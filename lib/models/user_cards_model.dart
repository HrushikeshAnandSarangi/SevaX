...
UserCardsModel userCardsModelFromJson(String str) => UserCardsModel.fromJson(json.decode(str));

String userCardsModelToJson(UserCardsModel data) => json.encode(data.toJson());
...
class UserCardsModel {
    ...
    factory UserCardsModel.fromJson(Map<String, dynamic> json) => UserCardsModel(
        object: json["object"],
        data: List<Cards>.from(json["data"].map((x) => Cards.fromJson(x))),
