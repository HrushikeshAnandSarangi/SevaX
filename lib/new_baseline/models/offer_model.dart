class OfferModel {
    ...
    factory OfferModel.fromMap(Map<String, dynamic> json) => new OfferModel(
        ...
        requestId: json["request_id"] == null ? null : new List<String>.from(json["request_id"].map((x) => x)),
        numberOfRequestees: json["number_of_requestees"] == null ? null : json["number_of_requestees"],
        approvedRequests: json["approved_requests"] == null ? null : new List<String>.from(json["approved_requests"].map((x) => x)),
    );
    ...
    Map<String, dynamic> toMap() => {
        ...
        "request_id": requestId == null ? null : new List<dynamic>.from(requestId.map((x) => x)),
        "number_of_requestees": numberOfRequestees == null ? null : numberOfRequestees,
        "approved_requests": approvedRequests == null ? null : new List<dynamic>.from(approvedRequests.map((x) => x)),
    };
}