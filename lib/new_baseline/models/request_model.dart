class OfferModel {
    ...
    factory OfferModel.fromMap(Map<String, dynamic> json) => new OfferModel(
        ...
        acceptors: json["acceptors"] == null ? null : new List<String>.from(json["acceptors"].map((x) => x)),
        numberOfVolunteers: json["number_of_volunteers"] == null ? null : json["number_of_volunteers"],
        approvedUsers: json["approved_users"] == null ? null : new List<String>.from(json["approved_users"].map((x) => x)),
        isAccepted: json["is_accepted"] == null ? null : json["is_accepted"],
        transactionModel: json["transaction_model"] == null ? null : new List<TransactionModel>.from(json["transaction_model"].map((x) => TransactionModel.fromMap(x))),
    );
    ...
    Map<String, dynamic> toMap() => {
        ...
        "acceptors": acceptors == null ? null : new List<dynamic>.from(acceptors.map((x) => x)),
        "number_of_volunteers": numberOfVolunteers == null ? null : numberOfVolunteers,
        "approved_users": approvedUsers == null ? null : new List<dynamic>.from(approvedUsers.map((x) => x)),
        "is_accepted": isAccepted == null ? null : isAccepted,
        "transaction_model": transactionModel == null ? null : new List<dynamic>.from(transactionModel.map((x) => x.toMap())),
    };
}
