...
class TimebankModel extends DataModel {
  ...
  TimebankModel(map) {
    ...
    this.coverUrl = map.containsKey("cover_url") ? map["cover_url"] : '';
  ...
  Map<String, dynamic> toMap() {
    Map<String, dynamic> map = {
      ...
      "cover_url": photoUrl == null ? null : coverUrl,
