...
//     try {
//       User user = await _loginWithEmailAndPassword(email, password);
...
//   /// Logout the logged in user from [User]
...
//   /// Login with [email] and [password]
//   Future<User> _loginWithEmailAndPassword(
//     String email,
//     String password,
//   ) async {
...
//   /// from [Firestore]
//   Future<UserModel> _processUser(User firebaseUser) async {
...
//         await CollectionRef.users.doc(emailId).get();
