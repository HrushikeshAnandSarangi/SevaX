...
class _PersonalNotificationsState extends State<PersonalNotifications>
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      subjectBorrow
          .transform(
              ThrottleStreamTransformer((_) => TimerStream(true, const Duration(seconds: 1))))
          .listen((data) {
                ...
                itemBuilder: (context, index) {
                  ...
                  switch (notification.type) {
                    ...
                    case NotificationType.RequestInvite:
                      RequestModel requestModel =
                          RequestModel.fromMap(notification.data['requestModel']);
                      TimebankModel timebankModel =
                          TimebankModel.fromMap(notification.data['timebankModel']);
                    ...
                    case NotificationType.MANUAL_TIME_CLAIM_APPROVED:
                      var body =
                          ManualTimeModel.fromMap(Map<String, dynamic>.from(notification.data));
                    ...
                    case NotificationType.NOTIFICATION_TO_LENDER_COMPLETION_RECEIPT:
                      ...
                      return NotificationCard(
                        ...
                        isDissmissible: true,
                        onDismissed: onDismissed,
                        onPressed: () => _handleFeedBackNotificationBorrowRequest(
                            context,
                            requestModelNew,
                            notification.id,
                            user.email,
                    ...
                    case NotificationType.LendingOfferIdleFirstWarning:
                      ...
                      return NotificationCard(
                        ...
                        photoUrl: model.photoUrlImage,
                        title:
                            model.individualOfferDataModel.title + S.of(context).idle_for_2_weeks,
                        subTitle:
                            S.of(context).idle_lending_offer_first_warning.replaceAll('***', '2'),
                      );
                      break;
                    ...
                    case NotificationType.LendingOfferIdleSecondWarning:
                      ...
                      return NotificationCard(
                        ...
                        photoUrl: model.photoUrlImage,
                        title:
                            model.individualOfferDataModel.title + S.of(context).idle_for_4_weeks,
                        subTitle:
                            S.of(context).idle_lending_offer_second_warning.replaceAll('***', '4'),
                      );
                      break;
                    ...
                    case NotificationType.BorrowRequestIdleFirstWarning:
                      ...
                      return NotificationCard(
                        ...
                        subTitle:
                            S.of(context).idle_borrow_request_first_warning.replaceAll('***', '2'),
                      );
                      break;
                    ...
                    case NotificationType.BorrowRequestIdleSecondWarning:
                      ...
                      return NotificationCard(
                        ...
                        subTitle:
                            S.of(context).idle_borrow_request_second_warning.replaceAll('***', '4'),
                      );
                      break;
  ...
  void _handleFeedBackNotificationBorrowRequest(BuildContext context, RequestModel requestModel,
      String notificationId, String email, FeedbackType feedbackType) async {
    Map results = await Navigator.of(context).push(
      MaterialPageRoute(
        builder: (context) => ReviewFeedback(
