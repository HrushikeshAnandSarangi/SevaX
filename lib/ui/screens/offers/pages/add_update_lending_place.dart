...
class AddUpdateLendingPlace extends StatefulWidget {
  ...
  final Function(LendingPlaceModel placeModel) onPlaceCreateUpdate;

  AddUpdateLendingPlace({this.lendingPlaceModel, this.onPlaceCreateUpdate});
...
class _AddUpdateLendingPlaceState extends State<AddUpdateLendingPlace> {
  ...
  void initState() {
    ...
    if (widget.lendingPlaceModel != null) {
      _bloc.loadData(widget.lendingPlaceModel);
      _placeNameController.text = widget.lendingPlaceModel.placeName;
      _guestsController.text = widget.lendingPlaceModel.noOfGuests.toString();
      _roomsController.text = widget.lendingPlaceModel.noOfRooms.toString();
      _bathroomsController.text =
          widget.lendingPlaceModel.noOfBathRooms.toString();
      _commonSpaceController.text = widget.lendingPlaceModel.commonSpace;
      _houseRulesController.text =
          widget.lendingPlaceModel.houseRules.toString();
    }
    setState(() {});
                              ...
                              if (imagesList == null ||
                                ...
                                if (widget.lendingPlaceModel == null) {
                                  ...
                                  _bloc.updateLendingOfferPlace(
                                      model: widget.lendingPlaceModel);
                                }
                              }
                            },
                            shape: StadiumBorder(),
