...
class _OneToManyOfferState extends State<OneToManyOffer> {
                      ...
                      child: Column(
                        children: <Widget>[
                          ...
                          Visibility(
                            ...
                            child: Container(
                              child: EditRepeatWidget(requestModel: null, offerModel: widget.offerModel),
                            ),
                          ),
                          SizedBox(height: 20),
                          StreamBuilder<String>(
                                ...
                                : () async {
                                    ...
                                    if (OfferDurationWidgetState.starttimestamp != 0) {
                                      ...
                                      if (widget.offerModel == null) {
                                        ...
                                        if(widget.offerModel.autoGenerated || widget.offerModel.isRecurring){
                                          showDialog(
                                                        ...
                                                        actions: [
                                                          FlatButton(
                                                            ...
                                                            onPressed: () async {
                                                              ...
                                                              _bloc.autoGenerated = widget.offerModel.autoGenerated;
                                                              _bloc.isRecurring = widget.offerModel.isRecurring;
  ...
  void updateOneToManyOfferFunc(int editType) async {
    if (_bloc.isRecurring || _bloc.autoGenerated) {
      ...
      end.after = (end.endType == "after" ? int.parse(EditRepeatWidgetState.after) : null);
      _bloc.end = end;
    }
