  ...
  Widget getAppropriateTag(RequestType requestType, BuildContext context) {
    switch (requestType) {
      case RequestType.CASH:
        return getTagMainFrame(S.of(context).offertag_cash_request, context);

      case RequestType.GOODS:
        return getTagMainFrame(S.of(context).offertag_goods_request, context);

      case RequestType.TIME:
        return getTagMainFrame(S.of(context).offertag_time_request, context);
