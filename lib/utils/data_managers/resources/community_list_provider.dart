...
class RequestApiProvider {
  ...
  Future<void> updateInvitedUsersForRequest(String requestID, sevauserid) async {
    List<String> list = List();
    list.add(sevauserid);

    await Firestore.instance.collection("requests").document(requestID).updateData({"invitedUsers": FieldValue.arrayUnion(list)}).then((onValue) {
