                      ...
                      onPressed: () async {
                        ...
                        if (widget.requestModel.requestMode ==
                          ...
                          if(widget.requestModel.isRecurring == true ||
                            ...
                            (widget.requestModel.end.after - widget.requestModel.occurenceCount).abs() : calculateRecurrencesOnMode(widget.requestModel);
                            onBalanceCheckResult = await RequestManager.hasSufficientCreditsIncludingRecurring(
