...
class _RequestOfferAgreementFormState extends State<RequestOfferAgreementForm> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        agreementDocumentType == AgreementDocumentType.NO_AGREEMENT.readable ?
                    ...
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          ...
                          _optionRadioButtonRoomForm<bool>(
                            title: 'Long-term (Month to Month)', //Label to be created
                            value: false,
                            groupvalue: isFixedTerm,
                            onChanged: (value) {
                              isFixedTerm = value;
  ...
  //         List<BorrowAgreementTemplateModel> projectTemplateList = snapshot.data;
