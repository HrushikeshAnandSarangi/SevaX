...
class SkillsEdit extends StatelessWidget {
  @override
...
class Skills extends StatefulWidget {
  @override
  _SkillsEditState createState() => _SkillsEditState();
}

class _SkillsEditState extends State<Skills> {
  _SkillsEditState() {
    _reset();
  }
  ...
  void _reset() {
    ...
    _selectedTools = Set<String>.from(globals.skills);
...
_updateSkillsToDB(BuildContext context) {
  globals.skills = globals.tempList;
