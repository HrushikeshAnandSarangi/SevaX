...
class EditSuperTimebankView extends StatefulWidget {
  ...
  EditSuperTimebankView({
    @required this.timebankId,
    @required this.superAdminTimebankModel,
  });

  @override
  _EditSuperTimebankViewState createState() => _EditSuperTimebankViewState();
}

class _EditSuperTimebankViewState extends State<EditSuperTimebankView> {
  ...
  void showDeleteConfirmation(TimebankModel model) {
    ...
    showDialog(
      ...
      builder: (buildContext) {
        return AlertDialog(
          title: Text(
              'Delete ${timebankModel.name == null ? "" : timebankModel.name}'),
          content: Text(
              'Are you sure you want to delete ${timebankModel.name == null ? "" : timebankModel.name}'),
          actions: <Widget>[
            RaisedButton(
              color: Colors.red,
              child: Text(
        ...
        switch (snapshot.connectionState) {
          ...
          default:
            ...
            return Scaffold(
              appBar: AppBar(
                title: Text(
                  '${timebankModel.name == null ? "" : timebankModel.name}',
...
//                          disabledTextColor:
//                          Theme.of(context).accentColor,s
//                          onPressed: () {
//
//                          },
//                        )
...
//                        ),
                        FlatButton(
                          child: Text(
                            'Edit ${FlavorConfig.values.timebankName == "Yang 2020" ? 'Yang Gang' : 'Timebank'} details',
                            style: TextStyle(fontWeight: FontWeight.bold),
                          ),
                          textColor: Theme.of(context).accentColor,
