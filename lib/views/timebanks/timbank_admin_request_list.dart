...
//   @override
//   _TimebankRequestAdminPageState createState() =>
//       _TimebankRequestAdminPageState();
// }

// class _TimebankRequestAdminPageState extends State<TimebankRequestAdminPage> {
//   Firestore _firestore = Firestore.instance;
//   List<UserModel> users = [];
//   List<UserModel> admins = [];
//   List<UserModel> requestedMember = [];
//   List<UserModel> requested = [];
//   List<String> reqId = [];
...
//   void initState() {
//     super.initState();
//     print(widget.timebank.id);
//     Future.delayed(Duration.zero, () {
//       isAdmin = widget.timebank.admins
//           .contains(SevaCore.of(context).loggedInUser.sevaUserID);
//     });

//     _firestore
//         .collection("join_requests")
//         .where("entity_id", isEqualTo: widget.timebank.id)
//         .where("accepted", isEqualTo: false)
//         .snapshots()
//         .listen((QuerySnapshot query) {
//       query.documents.forEach((DocumentSnapshot document) {
//         userDetail(document.data["user_id"]);
//       });

//       _firestore
//           .collection("users")
//           .where("membershipTimebanks", arrayContains: widget.timebank.id)
//           .snapshots()
//           .listen((QuerySnapshot query) {
//         users = [];
//         query.documents.forEach((DocumentSnapshot document) {
//           UserModel user = UserModel.fromMap(document.data);
//           print('${user.sevaUserID}');
//           if (widget.timebank.admins.contains(user.sevaUserID)) {
//             admins.add(user);
//           } else {
//             users.add(user);
//           }
...
//   Future<void> userDetail(String userId) async {
...
//         ),
//         ...admins.map((UserModel t) => getUserRequestWidget(user: t)).toList(),
//         Text(
//           'Requests',
//           style: TextStyle(fontSize: 20),
//         ),
//         ...requested
//             .map((UserModel t) =>
//                 getUserRequestWidget(user: t, isAdmin: isAdmin))
//             .toList(),
//         Text(
//           'Members',
//           style: TextStyle(fontSize: 20),
//         ),
//         ...users.map((UserModel t) => getUserWidget(user: t)).toList(),
//       ],
//     );
//   }
...
//     bool isAdmin = false,
//   }) {
//     user.photoURL = user.photoURL ?? defaultUserImageURL;
//     user.fullname = user.fullname ?? defaultUsername;
//     var item = Padding(
...
//     UserModel user,
//     TimebankModel model,
//     bool isPromoteBottonVisible = false,
//   }) {
...
//       color: Colors.white,
//       child: ListView(
//         children: getContent(context, timebankModel),
