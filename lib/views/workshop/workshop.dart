...
import 'package:sevaexchange/new_baseline/services/users/users_service.dart';
...
class SelectMembersInGroup extends StatefulWidget {
  ...
  SelectMembersInGroup( String timebankId,  HashMap<String, UserModel> userSelected){
      this.timebankId = timebankId;
      if (userSelected == null) userSelected = HashMap();
  }
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: <Widget>[
          GestureDetector(
            onTap: () {
              Navigator.of(context).pop({'membersSelected': widget.userSelected});
            },
            child: Container(
    ...
    return Column(
      ...
      children: <Widget>[
        ...model.members.map((member) {
          if (widget.listOfMembers.containsKey(member)) {
            print("From cache");
